        ...
        <div className="flex flex-wrap -mx-4">
            ...
            <div className="flex flex-wrap justify-between items-center">
              <div className="w-full lg:w-1/2 mb-10 lg:mb-0">
                ...
                <p className="text-lg md:text-xl leading-8 text-coolGray-500 font-semibold">
                  The Wampus is first introduced as a kitten in the story, but
                  later on, is described as panther-like creature that is
                  incredibly fast and strong. The Wampus is also nearly
                  impossible to kill. The Wampus has the least amount of
                  information written about it in the story, but it is said to
                  represent the body of a wizard or witch, much like how the
                  Thunderbird represents the soul and the Pukwudgie represents
                  the heart.
                </p>
              </div>
          ...
          <div className="w-full lg:w-1/2 px-4 mb-5 lg:mb-0">
            ...
            <p className="text-lg font-medium leading-7 text-coolGray-500">
              The Wampus was picked as a symbol for one of the houses by William
              Boot, another one of the founders, who fell in love with the
              creature and its abilities. Those sorted into Wampus are probably
              similar to those sorted into Gryffindor or Ravenclaw.
            </p>
          </div>
